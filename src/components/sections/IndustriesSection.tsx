...
export default function IndustriesSection() {
  return (
    <section className="border-y border-[#1e1e1e] bg-[#111111] py-20 lg:py-28">
            ...
            {industries.map((ind, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex items-start gap-3 rounded-sm border border-[#1e1e1e] bg-[#0a0a0a] p-4"
                >
                  <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-sm bg-[#1a56db]/10 text-[#1a56db]">
                    <Icon size={15} />
                  </div>
                  <div>
                    <div className="text-sm font-semibold text-[#f0f0f0]">{ind.label}</div>
                    <div className="mt-0.5 text-xs text-[#666]">{ind.sub}</div>
                  </div>
                </motion.div>
              );
            })}
