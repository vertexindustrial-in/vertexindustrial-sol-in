...
export default function AboutPageContent() {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-start gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            >
              ...
              <h2
                className="mb-6 text-4xl font-extrabold uppercase leading-tight text-[#f0f0f0] sm:text-5xl"
                style={{ fontFamily: "var(--font-barlow-condensed)" }}
              >
                Built Over Two Decades in the Ballari Region
              </h2>

              <div className="space-y-5 text-sm leading-relaxed text-[#888888]">
                <p>
            ...
            >
              {credentials.map((item, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex items-center gap-4 rounded-sm border border-[#1e1e1e] bg-[#111111] px-5 py-4"
                  >
              ...
              <motion.div
                ...
                className="rounded-sm border border-[#1a56db]/25 bg-[#1a56db]/5 px-5 py-4"
              >
                <div className="text-xs text-[#555]">Proprietor</div>
                <div className="mt-0.5 text-sm font-semibold text-[#f0f0f0]">H. Fareed Samdani</div>
      ...
      {/* ── Our Approach ── */}
      <section className="border-y border-[#1e1e1e] bg-[#111111] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            {pillars.map((pillar, i) => (
              <motion.div
                ...
                className="flex flex-col rounded-sm border border-[#1e1e1e] bg-[#0a0a0a] p-6"
              >
                <span
                  className="mb-4 text-4xl font-extrabold text-[#1a56db]/30"
                  style={{ fontFamily: "var(--font-barlow-condensed)" }}
                >
                  {pillar.number}
                </span>
                <h3
                  className="mb-3 text-xl font-bold uppercase text-[#f0f0f0]"
                  style={{ fontFamily: "var(--font-barlow-condensed)" }}
                >
                  {pillar.title}
                </h3>
                <p className="text-sm leading-relaxed text-[#888888]">{pillar.body}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#0a0a0a] py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-0 divide-y divide-[#1e1e1e] rounded-sm border border-[#1e1e1e]">
            {differentiators.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex flex-wrap items-start gap-x-4 gap-y-3 bg-[#111111] p-5 transition-colors hover:bg-[#111111]/80 sm:grid sm:grid-cols-[2.5rem_1fr_2fr] sm:items-start sm:gap-6 sm:p-6"
                >
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-sm bg-[#1a56db]/10 text-[#1a56db]">
                    <Icon size={18} />
                  </div>
                  <h3
                    className="min-w-0 flex-1 self-center text-lg font-bold uppercase text-[#f0f0f0] sm:flex-none sm:text-xl"
                    style={{ fontFamily: "var(--font-barlow-condensed)" }}
                  >
                    {item.title}
                  </h3>
                  <p className="w-full text-sm leading-relaxed text-[#888888] sm:w-auto sm:self-center">
                    {item.body}
                  </p>
                </motion.div>
              );
            ...
            >
              {[
                ...
                >
                  <Link
                    href={product.href}
                    className="group flex items-start gap-3 rounded-sm border border-[#1e1e1e] bg-[#0a0a0a] p-4 transition-colors hover:border-[#1a56db]/40"
                  >
                    <CheckCircle size={15} className="mt-0.5 shrink-0 text-[#1a56db]" />
                    <div>
                      <div className="text-sm font-semibold text-[#f0f0f0] transition-colors group-hover:text-[#1a56db]">
                        {product.name}
                      </div>
                      <div className="mt-0.5 text-xs text-[#666]">{product.detail}</div>
                    </div>
                    <ArrowRight
                      size={14}
                      className="ml-auto mt-0.5 shrink-0 text-[#333] transition-colors group-hover:text-[#1a56db]"
                    />
                  </Link>
                </motion.div>
              ))}
